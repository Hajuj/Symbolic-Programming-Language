...
from hw06_naive_bayes.naive_bayes_classifier import DataInstance, Dataset, NaiveBayesClassifier
...
class NaiveBayesTest(TestCase):
    ...
    def setUp(self):
        ...
        self.nbc2 = NaiveBayesClassifier.for_dataset(self.data_set_3, smoothing=1.0)
    ...
    def test02_for_dataset_01(self):
        ...
        self.assertEqual(self.nbc.word_and_cat_to_count,
                         {('lecture', 'promotions'): 1, ('morning', 'relevant'): 2, ('single', 'spam'): 3,
                          ('work', 'relevant'): 2, ('beach', 'spam'): 1,
                          ('lecture', 'relevant'): 3, ('professor', 'relevant'): 1, ('free', 'spam'): 2,
                          ('best', 'promotions'): 2, ('tomorrow', 'relevant'): 1,
                          ('top', 'spam'): 1, ('best', 'spam'): 1, ('meeting', 'relevant'): 3, ('hot', 'spam'): 4,
                          ('free', 'promotions'): 3})
    ...
    def test04_prediction_accuracy_01(self):
        ...
        self.assertAlmostEqual(self.nbc.prediction_accuracy(self.data_set_2), 0.8333333)
